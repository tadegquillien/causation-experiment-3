...
const TaskTutorialFour = (props) => {
    return (
        <div style={textStyle}>
            ...
            <p>The game consists in drawing a ball from each of four boxes.</p>
            <p>To win, you need to score at least {threshold} points.</p>
            <p>You will need to draw a ball from each of the four boxes before moving on to the next round.</p>
